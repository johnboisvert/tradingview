...
const EmbedGallery = React.lazy(() => import("./pages/EmbedGallery"));
    ...
    <Router>
      ...
      <Suspense fallback={<LoadingSpinner />}>
        <Routes>
          ...
          <Route path="/scanner-ia" element={<Navigate to="/performance" replace />} />
          ...
          {/* Public trader profile pages + embed gallery */}
