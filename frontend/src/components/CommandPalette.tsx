...
const NAV: NavItem[] = [
  ...
  { path: "/bullrun-phase", label: "Cycle du Marché (Phase & Régime)", section: "Marché" },
  ...
  { path: "/backtesting-visuel", label: "Laboratoire de Test (Backtest, Simulation, Allocation)", section: "IA & Analyse" },
  ...
  { path: "/ai-signals", label: "Signaux IA (BUY/SELL & Opportunités)", section: "IA & Analyse" },
