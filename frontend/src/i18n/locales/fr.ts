...
const fr = {
  ...
  pages: {
    ...
    heatmap: {
      ...
      caption: "Carte thermique du marché · Vert = Hausse · Rouge = Baisse · MAJ auto 60s",
      viewHeatmap: "🔥 Heatmap",
      viewTable: "📊 Tableau",
      lastUpdate: "MAJ {{time}}",
      refresh: "Rafraîchir",
      ...
      kpiAvgChange: "Variation Moy.",
      kpiGainers: "Hausses",
      kpiLosers: "Baisses",
      kpiRatio: "Ratio H/B",
      avgChange24h: "Variation moyenne 24h",
    ...
    pricing: {
      seoTitle: "Tarifs — CryptoIA",
      seoDesc: "Tous les plans CryptoIA : Gratuit, Premium, Pro, VIP. 7 jours gratuits, sans engagement.",
      title: "Choisis ton plan",
      subtitle: "7 jours gratuits · Sans engagement · Annule à tout moment",
      monthly: "Mensuel",
      yearly: "Annuel",
      yearlyDiscount: "-20%",
      currentPlan: "Plan actuel",
    ...
    compare: {
      seoTitle: "Comparer les cryptos — CryptoIA",
      seoDesc: "Compare jusqu'à 4 cryptos côte à côte : prix, market cap, volume, RSI, signaux IA.",
      title: "Comparer les cryptos",
      subtitle: "Sélectionne jusqu'à 4 cryptos pour les comparer en détail",
      addCrypto: "Ajouter une crypto",
      remove: "Retirer",
      noSelection: "Aucune crypto sélectionnée",
      noSelectionHint: "Utilise le sélecteur ci-dessus pour ajouter tes premières cryptos.",
    },
    glossary: {
      seoTitle: "Glossaire crypto — CryptoIA",
      seoDesc: "Définitions complètes des termes essentiels de la crypto et du trading : HODL, Whale, RSI, Liquidation et plus.",
      title: "Glossaire crypto & trading",
      subtitle: "Tous les termes essentiels expliqués simplement",
      searchPlaceholder: "Rechercher un terme…",
      noResults: "Aucun terme trouvé.",
      categoryAll: "Tous",
    },
    whaleWatcher: {
      seoTitle: "Whale Watcher — Surveille les baleines crypto",
      seoDesc: "Suivi en temps réel des plus grosses transactions on-chain. Détecte les mouvements de baleines BTC/ETH avant tout le monde.",
      title: "Whale Watcher",
      subtitle: "Mouvements on-chain en temps réel des plus gros wallets",
      ...
      amount: "Montant",
      txHash: "Hash",
      empty: "Pas encore de mouvement majeur détecté. La page se rafraîchit toutes les 30 secondes.",
    },
    parrainage: {
      seoTitle: "Programme d'affiliation — CryptoIA",
      seoDesc: "Parraine tes amis et gagne 1 mois gratuit Premium à chaque inscription Premium réussie.",
      title: "Programme d'affiliation",
      subtitle: "Invite tes amis, gagne 1 mois Premium offert à chaque parrainage validé",
      copyLink: "Copier mon lien",
      copied: "Copié !",
      yourCode: "Ton code de parrainage",
      yourLink: "Ton lien unique",
      stats: "Tes stats",
      referrals: "Parrainages",
      converted: "Conversions",
      monthsEarned: "Mois gratuits gagnés",
      shareNow: "Partager maintenant",
    },
    monCompte: {
      seoTitle: "Mon compte — CryptoIA",
      seoDesc: "Gère ton compte CryptoIA : abonnement, mot de passe, préférences, parrainage.",
      title: "Mon Compte",
      subtitle: "Gérez votre profil, abonnement et préférences",
      tabProfile: "Profil",
      tabAccount: "Compte",
      ...
      adminModeDesc: "Vous avez un accès complet à toutes les fonctionnalités. Déconnectez-vous de l'admin pour revenir au plan utilisateur.",
      subExpired: "Abonnement expiré",
      subExpiredDesc: "Votre abonnement a expiré le {{date}}. Renouvelez pour retrouver l'accès à toutes vos fonctionnalités.",
      renewalSoon: "Renouvellement imminent",
      renewalSoonDesc: "Votre abonnement se renouvelle dans {{count}} jour(s) ({{date}}).",
      planAdminDesc: "Accès administrateur complet à toutes les fonctionnalités.",
      planFreeDesc: "Accès limité aux fonctionnalités de base.",
      planPaidDesc: "Vous avez accès à toutes les fonctionnalités du plan {{plan}}.",
      billingPeriod: "Période de facturation",
      annual: "Annuel",
      monthly: "Mensuel",
      nextRenewal: "Prochain renouvellement",
      cancelSub: "Annuler l'abonnement",
      cancelSubDesc: "Vous conserverez l'accès jusqu'au {{date}}.",
      cancelButton: "Annuler",
      cancelConfirm: "Êtes-vous sûr de vouloir annuler votre abonnement ? Vous conserverez l'accès jusqu'à la fin de la période en cours.",
      renewSub: "Renouveler votre abonnement",
      upgradePlan: "Passer à un plan supérieur",
      renewDesc: "Renouvelez votre abonnement pour retrouver l'accès à toutes vos fonctionnalités.",
      upgradeDesc: "Débloquez plus de fonctionnalités en passant à un plan supérieur.",
      renewBtn: "Renouveler",
      viewPlansBtn: "Voir les abonnements",
      manageSub: "Gérer mon abonnement (Stripe)",
      eliteFull: "Vous disposez du plan le plus complet. Profitez de toutes les fonctionnalités !",
      security: "Sécurité",
      twofa: "Authentification à deux facteurs (2FA)",
      twofaDesc: "Ajoutez une couche de sécurité supplémentaire",
      activate: "Activer",
      apiKey: "Clé API",
      apiKeyDesc: "Votre clé pour accéder à l'API CryptoIA",
      notificationPrefs: "Préférences de Notifications",
      notifPriceAlerts: "Alertes de prix",
      notifPriceAlertsDesc: "Recevez des notifications quand un prix atteint votre cible",
      notifAiSignals: "Signaux IA",
      notifAiSignalsDesc: "Notifications pour les nouveaux signaux de trading",
      notifNews: "Nouvelles importantes",
      notifNewsDesc: "Alertes pour les actualités crypto majeures",
      notifWeekly: "Rapport hebdomadaire",
      notifWeeklyDesc: "Résumé de vos performances chaque semaine",
      notifProduct: "Mises à jour produit",
      notifProductDesc: "Nouvelles fonctionnalités et améliorations",
      logout: "Déconnexion",
    ...
    compareExtra: {
      loading: "Chargement…",
      empty: "Les comparatifs seront bientôt disponibles.",
      emptyAdminLink: "Admin : générer →",
    ...
    glossaryExtra: {
      loading: "Chargement…",
      empty: "Le glossaire sera bientôt disponible.",
      emptyAdminLink: "Admin : générer le glossaire →",
      allTerms: "Tous les termes",
      notFound: "Terme introuvable.",
    ...
    whaleWatcherExtra: {
      ...
      filters: "Filtres:",
      all: "Tous",
      avgScore: "Score whale moyen: {{score}}/100",
      colCrypto: "Crypto",
      colPrice: "Prix",
      col24h: "24h",
      colVolume24: "Volume 24h",
      colVolMcap: "Vol/MCap",
      colWhaleScore: "Score Whale",
      colSignal: "Signal",
      loadingData: "Chargement des données CoinGecko...",
      noActivity: "Aucune activité trouvée",
      methodology: "📖 Méthodologie",
      accDesc: "= Volume élevé + hausse de prix ou volume très élevé avec faible variation (achat silencieux)",
      distDesc: "= Volume élevé + baisse de prix significative (vente massive)",
      neutralDesc: "= Activité normale, pas de signal whale détecté",
      footer: "📊 Données en temps réel via CoinGecko API. Le score whale est calculé à partir du ratio Volume/Market Cap, de la variation 24h et du volume absolu. Aucune donnée simulée.",
      reasonRiseHighVol: "Hausse de {{change}}% avec volume élevé ({{ratio}}% du MCap) — accumulation probable",
      reasonFallHighVol: "Baisse de {{change}}% avec volume élevé ({{ratio}}% du MCap) — distribution probable",
      reasonSilent: "Volume très élevé ({{ratio}}% du MCap) avec faible variation — accumulation silencieuse",
      reasonBigFall: "Forte baisse de {{change}}% — pression vendeuse significative",
      reasonBigRise: "Forte hausse de {{change}}% — achat massif détecté",
      reasonNormal: "Activité normale — Vol/MCap: {{ratio}}%, Variation: {{change}}%",
    },
  },
  commandPalette: {
