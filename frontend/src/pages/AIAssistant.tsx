  ...
  const sendMessage = async () => {
    ...
    try {
      await client.ai.gentxt({
        ...
        onComplete: () => {
          setMessages((prev) => [
            ...
            {
              role: "assistant",
              content: fullContent || "Désolé, je n'ai pas pu générer de réponse. Veuillez réessayer.",
            },
          ]);
          setStreamingContent("");
          setIsTyping(false);
        ...
        onError: (err: { message?: string }) => {
          ...
          if (fullContent) {
            ...
            setMessages((prev) => [
              ...
              {
                role: "assistant",
                content: `⚠️ Erreur de l'IA: ${errMsg}. Veuillez réessayer dans quelques instants.`,
              },
            ]);
          }
          setStreamingContent("");
      ...
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          content: `⚠️ Erreur: ${errorMsg}. Vérifiez votre connexion et réessayez.`,
        },
      ]);
      setStreamingContent("");
      setIsTyping(false);
          ...
          <div className="relative z-10 h-full flex items-center justify-between px-8">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Propulsé par DeepSeek V3.2 • Réponses intelligentes en streaming
              </p>
            </div>
            <button
              onClick={clearChat}
        ...
        >
          ...
          <div className="p-4 border-t border-white/[0.06]">
            ...
            <p className="text-[10px] text-gray-600 mt-2 text-center">
              Propulsé par DeepSeek V3.2 • Les réponses ne constituent pas des
              conseils financiers
            </p>
          </div>
        </div>
