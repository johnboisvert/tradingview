      ...
      <main className="flex-1 md:ml-[260px] p-4 md:p-7 pt-[72px] md:pt-7 max-w-6xl mx-auto">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            {[
              { icon: "📧", title: t("contact.infoEmail"), value: "cryptoia2026@gmail.com" },
              { icon: "💬", title: t("contact.infoDiscord"), value: "discord.gg/cryptoia" },
              { icon: "⏰", title: t("contact.infoResponse"), value: t("contact.infoResponseValue") },
            ].map((info) => (
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">{t("contact.nameLabel")}</label>
                  <input
                    type="text"
                    value={form.name}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">{t("contact.emailLabel")}</label>
                  <input
                    type="email"
                    value={form.email}
              ...
              <div className="flex flex-col gap-1.5 mb-5">
                <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">{t("contact.subjectLabel")}</label>
                <select
                  value={form.subject}
              ...
              <div className="flex flex-col gap-1.5 mb-6">
                <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">{t("contact.messageLabel")}</label>
                <textarea
                  value={form.message}
          ...
          <div className="mt-10 bg-slate-900/50 border border-white/5 rounded-3xl p-8 max-w-2xl mx-auto">
            <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-2">❓ {t("contact.faq")}</h2>
            {[
              { q: t("contact.faqCancelQ"), a: t("contact.faqCancelA") },
              { q: t("contact.faqRealtimeQ"), a: t("contact.faqRealtimeA") },
              { q: t("contact.faqMobileQ"), a: t("contact.faqMobileA") },
            ].map((faq, i) => (
