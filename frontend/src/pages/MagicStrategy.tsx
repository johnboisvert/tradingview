...
const INDICATORS: Indicator[] = [
  ...
  {
    id: "magic-sr-ai",
    name: "Magic JB S/R AI",
    tagline: "Supports et résistances automatiques multi-timeframes",
    icon: Layers,
    accent: ACCENTS.emerald,
    description: [
      "Magic JB S/R AI est un indicateur avancé de supports et résistances conçu spécialement pour les marchés de cryptomonnaies. Il analyse automatiquement la structure du prix afin d'identifier les zones où les acheteurs et les vendeurs ont historiquement démontré une présence importante.",
      "Contrairement à un indicateur qui trace simplement chaque sommet et chaque creux, Magic JB S/R AI filtre les niveaux faibles, regroupe les niveaux trop rapprochés et conserve principalement les zones les plus pertinentes. Il fonctionne sur tous les principaux horizons temporels, du scalping jusqu'à l'investissement à long terme.",
      "Il utilise les données réelles du graphique : ouverture, plus haut, plus bas, clôture, structure des pivots, volatilité, réactions historiques du prix, proximité entre plusieurs niveaux et confirmations provenant de timeframes supérieurs. L'indicateur n'invente pas de prix futur et ne prétend pas prédire le marché avec certitude.",
      "Zones plutôt que lignes uniques : les supports (zones vertes — demande) et résistances (zones rouges — pression vendeuse) sont affichés comme des zones de réaction dont la largeur s'adapte à la volatilité, à l'ATR, au timeframe et à la distance entre les pivots. Étroites sur les petits timeframes, plus larges sur les timeframes élevés.",
      "Analyse multi-timeframe : l'indicateur peut combiner les niveaux du graphique actuel avec le 1 h, 4 h, journalier et hebdomadaire. Les niveaux des timeframes supérieurs sont plus structurants — une résistance hebdomadaire compte plus qu'une résistance détectée sur un 5 minutes.",
      "Zones locales et zones macro : les zones locales (timeframe actuel) servent au scalping, au trading intrajournalier et aux entrées précises ; les zones macro (timeframe supérieur ou structure historique) servent au swing, aux objectifs majeurs, aux retournements importants et à la gestion du risque long terme. Le type est indiqué directement dans l'étiquette sur le graphique.",
      "Système de force sur 10 : chaque zone est évaluée selon le nombre de réactions historiques, la qualité des pivots, l'ancienneté, la présence sur plusieurs timeframes, la proximité d'autres niveaux et l'importance du mouvement créé. 5-6/10 : zone valide mais secondaire · 7-8/10 : zone importante · 9/10 : zone très forte · 10/10 : zone majeure avec forte confluence.",
      "Filtrage automatique : fusion des niveaux trop rapprochés, élimination des zones trop faibles, limitation des zones trop éloignées, priorisation des niveaux près du prix et conservation des zones macro importantes. Le résultat est un graphique plus propre et plus facile à interpréter.",
      "Cassures de zones : un support perd sa validité si le prix clôture clairement dessous (et inversement pour une résistance). Après cassure, un ancien support peut devenir résistance, et le prix peut revenir tester la zone. Il est préférable d'attendre une clôture confirmée plutôt que de considérer chaque mèche comme une cassure définitive.",
      "Utilisation : une zone ne doit pas être utilisée seule comme signal automatique. Cherchez une confirmation : bougie de rejet, reprise de structure, cassure + retest, augmentation du volume, divergence ou réaction sur un timeframe supérieur. Les zones historiques représentent des probabilités et non des certitudes — la volatilité, les nouvelles économiques ou les liquidations peuvent traverser n'importe quel niveau.",
    ],
    features: [
      "Supports et résistances automatiques",
      "Fonctionnement multi-timeframe (1H, 4H, D, W)",
      "Zones locales et macro",
      "Largeur adaptée à la volatilité (ATR)",
      "Système de force sur 10",
      "Regroupement des niveaux similaires",
      "Filtrage des zones secondaires",
      "Distances en pourcentage vers support/résistance",
      "Pivots confirmés (pas de sommets en formation)",
      "Utilisable en scalping, day trading, swing et investissement",
    ],
    dashboard: [
      "TF — timeframe actuel du graphique",
      "Priorité — logique de sélection des zones (mode automatique)",
      "Support / Résistance — niveaux actifs les plus pertinents avec force /10",
      "Vers résistance / Vers support — distance en % depuis le prix",
      "État — dans une zone, entre deux zones, proche S/R ou en range",
      "MTF actifs — timeframes supérieurs utilisés dans l'analyse",
      "Confirmé — zones issues de pivots confirmés uniquement",
    ],
    timeframes: "5 min au Weekly (scalping → investissement long terme)",
    screenshots: [
      {
        src: "/indicators/magicsr-1.png",
        caption: "ETH/USDT 1D — Zones macro filtrées avec force 9/10 et 10/10, tableau de bord complet (MTF D+W confirmés).",
      },
      {
        src: "/indicators/magicsr-2.png",
        caption: "BTC/USDT 1W — Niveaux hebdomadaires historiques : supports 8/10 en zone active et résistances majeures.",
      },
      {
        src: "/indicators/magicsr-3.png",
        caption: "BTC/USDT 1h — Zones locales étroites avec MTF actifs 60/240/D/W et distances en % vers S/R.",
      },
      {
        src: "/indicators/magicsr-4.png",
        caption: "BTC/USDT 15m — Zones intrajournalières précises pour le scalping, force 8/10 à 10/10, état ZONE ACTIVE.",
      },
    ],
    ready: true,
  },
