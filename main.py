...
async def send_telegram_advanced(trade: TradeWebhook):
    ...
    try:
        ...
        # Heure du Québec (UTC-5)
        now_utc = datetime.utcnow()
        now_quebec = now_utc - timedelta(hours=5)
...
async def webhook(trade: TradeWebhook):
    ...
    try:
        ...
        # Envoyer le message Telegram professionnel
        await send_telegram_advanced(trade)
        
        # Calculer confiance et sauvegarder
...
async def home():
    html = """<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Dashboard</title>""" + CSS + """</head><body><div class="container"><div class="header"><h1>DASHBOARD TRADING</h1><p>Toutes sections opérationnelles ✅</p></div>""" + NAV + """<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px"><div class="card"><h2>✅ Status</h2><p>Dashboard en ligne</p></div><div class="card"><h2>📊 Sections</h2><p>12 pages actives</p></div><div class="card"><h2>🔄 APIs</h2><p>Temps réel</p></div></div></div></body></html>"""
    return HTMLResponse(html)

@app.get("/api/fear-greed-full")
async def fear_greed_api():
    try:
        print("🔍 Tentative de récupération Fear & Greed...")
...
if __name__ == "__main__":
    ...
    print("\n" + "="*70)
    print("🚀 DASHBOARD TRADING - VERSION FINALE")
    print("="*70)
    print(f"📡 Port: {port}")
